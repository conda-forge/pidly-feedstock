About pidly-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pidly-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=780&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pidly-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pidly` can be installed with `conda`:
...
It is possible to list all of the versions of `pidly` available on your platform with `conda`:
...
```
mamba search pidly --channel conda-forge
```
...
mamba repoquery search pidly --channel conda-forge

# List packages depending on `pidly`:
mamba repoquery whoneeds pidly --channel conda-forge

# List dependencies of `pidly`:
mamba repoquery depends pidly --channel conda-forge
```
